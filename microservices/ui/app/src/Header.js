...
export default class Headerbar extends React.Component {   
    ...
    <Paper style={toolbarstyle} zDepth={1} >
     ...
     <Search style={searchstyle}/>
      ...
      <FlatButton label='Hello!! Sign in' labelStyle={label} style={{backgroundColor:'#f0c14b',display:'inline',paddingLeft:'15px',marginTop: '15px',float:'right',marginRight:'5px'}} />
