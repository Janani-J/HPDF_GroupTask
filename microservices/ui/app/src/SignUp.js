  ...
  render() {
    ...
    <div >
      ...
      <TextValidator onChange={this.handleChange}
        ...
        <br /><br/>
        <p style={{fontSize:'13px',color: '#111',fontWeight:'bold',fontFamily:'helvetica',paddingLeft:'25px',paddingTop:'0px',marginBottom:'0px'}}>Already have an account?<span class="help" style={{paddingLeft:'10px'}}>Sign in</span></p>
      </div>
      </Paper>
      </div>
  );
